			...
			<div class="card-body">
				<form class="forms-sample">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control datepicker" id="exampleInputEmail2" placeholder="tanggal surat">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="row">
						<div class="col-sm-9 offset-3">
							<div class="row">
						<div class="col-sm-9 offset-3">
							<a href="<?php echo base_url('surat/index')?>" class="btn btn-gradient-primary btn-icon-text">Tambah Surat</a>
