		...
		<div class="card">
			<div class="card-body">
				<form class="forms-sample">
					...
					<div class="form-group row">
						<label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Disposisi dari</label>
						<div class="col-sm-9">
							<p class="col-form-label">Biro Hukum</p>
						</div>
					</div>
					<div class="form-group row">
						<label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Isi Disposisi</label>
						<div class="col-sm-9">
							<p class="col-form-label">Hadiri</p>
						</div>
					</div>
					<div class="row">
